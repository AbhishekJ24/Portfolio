...
const Project = ({ imgpath, title, stack1, stack2, stack3, stack4, stack5, githublink, projlink }) => {
    return (
        <>
            <div>
                ...
                <motion.div initial={{ opacity: 0, scale: 0.5 }}
                    ...
                    <motion.a whileHover={{ scale: 1.05 }}
                        whileTap={{ scale: 1 }} className='proj-btns text-xs p-3 rounded-lg text-white mt-5 w-[10rem] font-semibold' href={githublink} target='_blank'>
                        GitHub Repository
                    </motion.a>
                    <motion.a whileHover={{ scale: 1.05 }}
                        whileTap={{ scale: 1 }} className='proj-btns text-xs p-3 rounded-lg text-white mt-1 w-[10rem] font-semibold' href={projlink} target='_blank'>
                        Visit Project
                    </motion.a>
                </motion.div>
            </div>
